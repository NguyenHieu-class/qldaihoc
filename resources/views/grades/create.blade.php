                    ...
                    <form method="POST" action="{{ route('grades.store') }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="number" step="0.1" min="0" max="10" class="form-control @error('assignment_score') is-invalid @enderror" id="assignment_score" name="assignment_score" value="{{ old('assignment_score') }}">
